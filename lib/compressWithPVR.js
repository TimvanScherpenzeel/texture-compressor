...
const compressWithPVR = () => {
	...
	if (PVRSupportedInputTypes.includes(inputFileExtension)) {
		...
		} else if (compression === 'pvrtc2') {
			console.log('Please note that PVRTC2 is not supported by iOS');
			if (bitrate === 2) {
				compressionFlag = 'PVRTC2_2';
			} else if (bitrate === 4) {
				compressionFlag = 'PVRTC2_4';
			}
		}
